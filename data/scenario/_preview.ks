...
[tb_image_show  time="2501"  storage="default/tatemono_restaurant.png"  width="250"  height="210"  x="522"  y="82"  _clickable_img=""  name="img_23"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="s4.ogg"  ]
[tb_start_text mode=1 ]
#Misaki
asoko no resutoran wa oishisou desu ne[p]
...
[tb_start_text mode=1 ]
#Misaki
sumimasen. Menyuu o misete kudasai[p]
...
[tb_start_text mode=1 ]
#Misaki
ahamado san, kore wa nan desu ka[p]
...
[tb_start_text mode=1 ]
#Ahmad
hitusji niku no shaweruma desu[p]
...
[tb_start_text mode=1 ]
#Misaki
chikin shaweruma ga arimasu ka[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#Misaki
ja, watashi wa chikin shaweruma ni shimasu[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#Ahmad
boku mo chikin shaweruma ni shimasu[p]
...
[tb_start_text mode=1 ]
#Ahmad
Sumimasen, chikin shaweruma wo futatsu kudasai[p]
